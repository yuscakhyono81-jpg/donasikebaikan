...
import { staffVerifyDonation } from "../../actions";
...
export default async function StaffVerifyPage() {
  ...
  async function handleVerify(formData: FormData) {
    ...
    await staffVerifyDonation(id, action === "approve");
  }
              ...
              <div key={d.id as string} className="bg-white rounded-2xl border border-slate-200 p-5">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    {d.proof_url && (
                      <a href={d.proof_url as string} target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm text-primary-600 hover:underline font-medium">
                  ...
                  <div className="flex gap-2 shrink-0">
                    <form action={handleVerify}>
                      ...
                      <button type="submit" className="flex items-center gap-1.5 px-3 py-1.5 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 transition-colors">
                    ...
                    <form action={handleVerify}>
                      ...
                      <button type="submit" className="flex items-center gap-1.5 px-3 py-1.5 bg-red-600 text-white text-sm font-semibold rounded-lg hover:bg-red-700 transition-colors">
